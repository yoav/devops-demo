...
default['tomcat7']['java_args'] = {'-Xmx256M'=>nil, '-Dajva.awt.headless'=>'true', '-Dgrails.env'=>'dev', '-XX:MaxPermSize'=>'256M', '-XX:+UseG1GC'=>nil, '-XX:MaxGCPauseMillis'=>'1000'}
...
##
set[:tomcat7][:url]  = "http://#{node['art_host']}:#{node['art_port']}/artifactory/devops-repo/tomcat/apache-tomcat-#{node[:tomcat7][:version]}.tar.gz"
